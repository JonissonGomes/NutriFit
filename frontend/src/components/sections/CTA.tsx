      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-balance">
            Sua prática nutricional digital, do jeito que você precisa
          </h2>

          <p className="text-xl md:text-2xl text-primary-100 mb-10 max-w-2xl mx-auto text-balance">
            Cadastre-se, prescreva planos alimentares e acompanhe seus pacientes com ferramentas pensadas para nutricionistas.
          </p>
