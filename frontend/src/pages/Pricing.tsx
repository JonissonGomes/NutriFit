  ...
  const plans: PricingPlan[] = [
    {
      ...
      price: 'R$ 149',
      period: '/mês',
      description: 'Para arquitetos autônomos e freelancers',
      highlighted: false,
      cta: 'Começar teste grátis',
      features: [
        { text: 'Até 10 projetos ativos', included: true },
        { text: '50GB de armazenamento', included: true },
        { text: 'Upload de plantas, renders e fotos', included: true },
        { text: 'Sistema de aprovação por etapas', included: true },
        { text: 'Visualizador de plantas (PDF/DWG)', included: true },
        { text: 'Portfólio público', included: true },
        { text: 'Timeline de projeto', included: true },
        { text: 'Orçamentos e contratos', included: true },
    ...
    },
    {
      ...
      price: 'R$ 399',
      period: '/mês',
      description: 'Para escritórios e equipes de arquitetura',
      highlighted: true,
      cta: 'Começar teste grátis',
      features: [
        ...
        { text: 'Orçamentos, contratos e propostas', included: true },
